...
install_target=../../turtlebot3_teleop_robot_ws/src/intdash_edge_raspi/opt/vm2m
...
## copy conf file
sudo cp ./conf/turtlebot3/* ../../turtlebot3_teleop_robot_ws/src/intdash_edge_raspi/opt/vm2m/etc
...
sudo cp dummy.sh ../..//turtlebot3_teleop_robot_ws/src/intdash_edge_raspi/opt/vm2m/sbin/
sudo chmod 755 ../..//turtlebot3_teleop_robot_ws/src/intdash_edge_raspi/opt/vm2m/sbin/dummy.sh
